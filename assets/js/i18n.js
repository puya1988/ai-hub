...
window.AI_I18N = {
  ...
  zh: {
    ...
    "search.loadingHw": "正在加载硬件数据（选型、厂商、成本测算）…",
    "search.loadingHwHint": "硬件数据按需加载，加载完成后会自动补上相关结果",
    "search.type.news": "资讯",
    ...
    "hw.price": "参考价格",
    "hw.vendorTitle": "品牌与供应商",
    "hw.vendorHint": "分九类整理了 56 家主流与国产方案，可按分类筛选或直接搜索。选品牌前先想清楚生态、供货、支持这三件事。",
    "hw.vendorSearch": "搜索品牌、产品线或地区…",
    "hw.vendorProducts": "代表产品",
    "hw.vendorCount": "共 {n} 家",
    "hw.vendorNone": "没有匹配的品牌",
    "hw.laptopTitle": "笔记本与移动方案",
    "hw.laptopHint": "移动端有三个硬约束：显存天花板、功耗墙、散热缩水。先确定你是「移动办公 + 云 API」还是「必须离网跑模型」。",
    "hw.laptopPointsTitle": "上手前先知道这五件事",
    "hw.laptopUnitsTitle": "六类机型怎么选",
    "hw.calcTitle": "算力租赁 vs 自建：成本临界点",
    "hw.calcHint": "给定方案、电费、运维与云价，算出「自己买几个月回本」以及租用与自建各自的真实成本。所有计算在本地完成。",
    "hw.calcPreset": "参考方案",
    "hw.calcCustom": "自定义",
    "hw.calcHours": "每月运行小时",
    "hw.calcOwnMonthly": "自建月成本",
    "hw.calcCloudMonthly": "云租月成本",
    "hw.calcBreakeven": "回本周期",
    "hw.calcOwnTotal": "自建累计",
    "hw.calcCloudTotal": "云租累计",
    "hw.calcMonths": "{n} 个月",
    "hw.calcNever": "在本参数下不会回本",
    "hw.calcVerdictCloudNever": "建议租用：云租月成本（{c}）已经不高于自建的 {o}，自建永远无法回本——因为你每月都在多花钱，还额外压了一笔采购款。",
    "hw.calcVerdictOwn": "建议自建：约 {n} 个月后自建开始更省，{m} 个月周期内可省 {s}。",
    "hw.calcVerdictOwnLong": "自建更省：月成本已经低于云租，从第一个月就开始划算，{m} 个月可省 {s}。",
    "hw.calcVerdictCloud": "建议租用：{m} 个月内自建无法回本（需要 {n} 个月以上），短期弹性需求用云更划算。",
    "hw.calcVerdictClose": "临界状态：两者差距不大（{m} 个月内相差 {s}），建议优先考虑弹性与运维负担，而不是单纯比价。",
    "hw.calcTableTitle": "各时间点累计成本对比",
    "hw.calcPeriod": "周期",
    "hw.calcDiff": "差额",
    "hw.calcCheaper": "更省",
    "hw.calcChartOwn": "自建累计",
    "hw.calcChartCloud": "云租累计",
    "hw.calcChartTitle": "累计成本曲线",
    "hw.calcCrossover": "临界点",
    "hw.calcCloudRef": "云租单价参考",
    "hw.calcCloudRefName": "算力规格",
    "hw.calcCloudRefPrice": "参考单价",
    "hw.calcCloudRefNote": "说明",
    "hw.calcCaveats": "这个模型没算什么",
    "hw.calcSalvage": "期末残值",
    "hw.calcSliders": "拖动试试：这三个变量对临界点影响最大",
    "hw.calcSliderPrice": "电价",
    "hw.calcSliderOps": "运维人力",
    "hw.calcSliderCloud": "云租单价",
    "hw.calcSliderMonths": "比较周期",
    "hw.calcReset": "恢复方案默认值",
    "hw.calcDataNote": "硬件行情数据截至",
    "hw.calcDataSrc": "已按 2026 年 9 月在售型号校准（RTX 50 系 / RTX PRO Blackwell / GB300 / B200 / MI350 / Rubin）。",
    "hw.vendorDataNote": "厂商与产品线数据核对于 2026-09，来源：厂商官方产品页与公开规格表。硬件迭代快，具体型号与价格请以官方为准。",
    "hw.calcOpsHint": "运维是固定成本：如果你有多个节点，按节点数分摊后再填。单个节点全额计入。",
    "hw.searchType": "硬件",
    "accent.indigo": "靖蓝",
    "accent.indigo": "靖蓝",
  ...
  en: {
    ...
    "search.loadingHw": "Loading hardware data (sizing, vendors, cost model)…",
    "search.loadingHwHint": "Hardware data loads on demand; matching results will appear automatically",
    ...
    "hw.vendorTitle": "Brands and vendors",
    "hw.vendorHint": "56 vendors across nine categories, including Chinese domestic options. Filter by category or search directly — but decide on ecosystem, availability and support first.",
    "hw.vendorSearch": "Search brand, product line or region…",
    "hw.vendorProducts": "Notable products",
    "hw.vendorCount": "{n} vendors",
    "hw.vendorNone": "No matching vendors",
    "hw.laptopTitle": "Laptops and mobile",
    "hw.laptopHint": "Mobile brings three hard constraints: a VRAM ceiling, a power limit and thermal throttling. Decide first whether you are cloud-first or must run models offline.",
    "hw.laptopPointsTitle": "Five things to know first",
    "hw.laptopUnitsTitle": "Six classes of machine",
    "hw.calcTitle": "Rent vs buy: the crossover point",
    "hw.calcHint": "Given a configuration, electricity, ops and cloud rates, work out how many months it takes to pay back owning, and what each option really costs. All computed locally.",
    "hw.calcPreset": "Configuration",
    "hw.calcCustom": "Custom",
    "hw.calcHours": "Hours per month",
    "hw.calcOwnMonthly": "Own monthly cost",
    "hw.calcCloudMonthly": "Rent monthly cost",
    "hw.calcBreakeven": "Payback period",
    "hw.calcOwnTotal": "Own cumulative",
    "hw.calcCloudTotal": "Rent cumulative",
    "hw.calcMonths": "{n} months",
    "hw.calcNever": "Never pays back at these settings",
    "hw.calcVerdictCloudNever": "Rent: the cloud monthly cost ({c}) is already at or below owning ({o}), so owning never pays back — you would spend more every month on top of the capex.",
    "hw.calcVerdictOwn": "Buy: owning becomes cheaper after about {n} months, saving {s} over {m} months.",
    "hw.calcVerdictOwnLong": "Buy: the monthly cost is already below renting, so it pays from month one — {s} saved over {m} months.",
    "hw.calcVerdictCloud": "Rent: owning does not pay back within {m} months (it needs {n}+), so cloud wins for short-term or elastic demand.",
    "hw.calcVerdictClose": "Borderline: the two are close (a {s} gap over {m} months). Decide on elasticity and operational burden rather than price alone.",
    "hw.calcTableTitle": "Cumulative cost at each horizon",
    "hw.calcPeriod": "Horizon",
    "hw.calcDiff": "Difference",
    "hw.calcCheaper": "cheaper",
    "hw.calcChartOwn": "Own cumulative",
    "hw.calcChartCloud": "Rent cumulative",
    "hw.calcChartTitle": "Cumulative cost curve",
    "hw.calcCrossover": "Crossover",
    "hw.calcCloudRef": "Cloud rate reference",
    "hw.calcCloudRefName": "GPU class",
    "hw.calcCloudRefPrice": "Indicative rate",
    "hw.calcCloudRefNote": "Notes",
    "hw.calcCaveats": "What this model leaves out",
    "hw.calcSalvage": "Terminal salvage",
    "hw.calcSliders": "Drag these: the three variables that move the crossover most",
    "hw.calcSliderPrice": "Electricity price",
    "hw.calcSliderOps": "Operations labour",
    "hw.calcSliderCloud": "Cloud rate",
    "hw.calcSliderMonths": "Horizon",
    "hw.calcReset": "Reset to preset defaults",
    "hw.calcDataNote": "Hardware data as of",
    "hw.calcDataSrc": "Calibrated against September 2026 shipping parts (RTX 50 series / RTX PRO Blackwell / GB300 / B200 / MI350 / Rubin).",
    "hw.vendorDataNote": "Vendor and product-line data verified in 2026-09 from official product pages and public specification tables. Hardware moves fast — confirm models and pricing officially.",
    "hw.calcOpsHint": "Operations is a fixed cost: if you run several nodes, divide it by the node count before entering it here. A single node bears it in full.",
